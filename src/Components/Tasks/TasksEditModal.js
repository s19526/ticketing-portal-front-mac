                    ...
                    <Modal.Body>
                        <Form className="mx-4" onSubmit={this.handleSubmit}>
                            ...
                            <Form.Group className="mb-3" controlId="TaskSummary">
                                ...
                                <Form.Control type="text" name="TaskSummary" autoFocus required
                                              defaultValue={this.props.t?.summary}
                            ...
                            <Form.Group className="mb-3" controlId="TaskDesc">
                                ...
                                <Form.Control as="textarea" rows={4} name="TaskDesc" required
                            ...
                            <Form.Group className="mb-3" controlId="TaskCreated">
                                ...
                                <Form.Control type="text" name="TaskCreated" required
                                              defaultValue={this.props.t?.dateCreated} disabled
                                              placeholder="Created at"></Form.Control>
                            </Form.Group>
                            <Form.Group className="mb-3" controlId="TaskSource">
                                <Form.Label>Created from</Form.Label>
                                <Form.Control type="text" name="TaskSource" required defaultValue={this.props.t?.source}
                                              disabled placeholder="Source"></Form.Control>
                            </Form.Group>
